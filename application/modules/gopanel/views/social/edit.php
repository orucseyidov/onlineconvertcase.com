                    ...
                    <div class="card-body">
                        <form action="<?=$class."/".$method ?>?id=<?=$id ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                    <label>Link</label>
                                    <input type="text" name="link" class="form-control" value="<?=$values['link'] ?>" required>
                                </div>

                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                    <label>İkon kodunu daxil edin</label>
                                    <input type="text" name="icon" class="form-control" value="<?=$values['icon'] ?>" required>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                    <label> </label>
                                    <button style="margin-top: 10px;" type="button" class="btn btn-primary waves-effect waves-light btn-block select_icon" data-toggle="modal" data-target="#iconSocial">İkonu Dəyiş : <i class="<?=$icone ?>"></i> </button>
                                </div>
