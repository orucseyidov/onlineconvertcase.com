...
?>
                                <tr>
                                    <td><?=$counter++ ?></td>
                                    <td><a target="_blank" href="<?=$value['image'] ?>"><img width="50" src="<?=$value['image'] ?>"></a></td>
                                    <td><?=$value['fullname'] ?></td>
                                    <td><?=$value['username'] ?></td>
                                    <td>
                                        <?php 
                                            if ($value['status'] == 1) {
                                               echo'<span class="badge badge-primary badge-pill">Admin</span>';
                                            }
                                            else{
                                                echo'<span class="badge badge-primary badge-pill">Moderator</span>';
                                            }
                                        ?>
                                    </td>
                                    <td>
