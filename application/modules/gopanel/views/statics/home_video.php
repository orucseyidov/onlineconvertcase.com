                        ...
                        <form action="/gopanel/<?=$class."/".$table ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                    <label>Say [1]</label>
                                    <input type="text" name="number_1" class="form-control" value="<?=$values['number_1'] ?>" required>
                                </div>

                                <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                    <label>Say [2]</label>
                                    <input type="text" name="number_2" class="form-control" value="<?=$values['number_2'] ?>" required>
                                </div>

                                <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                    <label>Say [3]</label>
                                    <input type="text" name="number_3" class="form-control" value="<?=$values['number_3'] ?>" required>
                                </div>

                                <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                    <label>Say [4]</label>
                                    <input type="text" name="number_4" class="form-control" value="<?=$values['number_4'] ?>" required>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label>Video <small>Youtube id</small></label>
                                    <input type="text" name="video" class="form-control" value="<?=$values['video'] ?>" required>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label>Şəkil Seçin</label>
                                    <small class="pull-right imgnotfiy">Ölçü 750 x 450</small>
