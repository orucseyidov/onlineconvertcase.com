    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          <div class="output" id="output">
              Type or paste your content here Type or paste your content here Type or paste your content here Type or paste your content here Type or paste your content here
          </div>
        </div>
        <div class="col-12">
          <div class="counters">
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 other-tool-btn-block">
                  <div class="modifier-select trim-whitespace" style="display: flex;justify-content: center;align-items: center;">
                    <label class="mb-0">Times to Repeat</label>
                    <input type="number" min="2" max="1000" step="1" class="" id="repetitions" value="5">
                  </div>
